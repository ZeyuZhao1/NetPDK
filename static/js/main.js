document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderGame(state){ selectedCardIndexes=[]; const myData=state.players.find(p=>p.sid===mySid); myName.textContent=myData?`${myData.name} (你)`:'我的手牌'; currentHand=sortCards(state.my_hand.slice()); renderCards(myHandDiv,currentHand);
